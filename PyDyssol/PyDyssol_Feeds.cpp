...
pybind11::dict PyDyssol::GetUnitFeedOverallAllTimes(const std::string& unitName) {
...
pybind11::dict PyDyssol::GetUnitFeedCompositionAllTimes(const std::string& unitName) {
...
pybind11::dict PyDyssol::GetUnitFeedDistributionAllTimes(const std::string& unitName) {
...
pybind11::dict PyDyssol::GetUnitFeedAllTimes(const std::string& unitName) {
    pybind11::dict result;
    result["overall"] = GetUnitFeedOverallAllTimes(unitName);
    result["composition"] = GetUnitFeedCompositionAllTimes(unitName);
    result["distributions"] = GetUnitFeedDistributionAllTimes(unitName);
    return result;
}